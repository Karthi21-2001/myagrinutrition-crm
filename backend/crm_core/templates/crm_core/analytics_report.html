...
<body class="min-h-full flex flex-col antialiased custom-scrollbar pb-12">
    ...
    <main class="flex-1 max-w-[1600px] w-full mx-auto p-4 space-y-6 mt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <!-- Diagnostic Problems Observations Matrix -->
            <div class="bg-[var(--bg-card)] p-5 rounded-xl border border-[var(--border)] h-80 flex flex-col justify-between shadow-lg">
                <div>
            ...
            <!-- Funnel Status Conversion Matrix -->
            <div class="bg-[var(--bg-card)] p-5 rounded-xl border border-[var(--border)] h-80 flex flex-col justify-between shadow-lg">
                <div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            new Chart(ctxMonth, {
                type: 'line',
                data: { 
                    labels: {{ month_labels_json|safe|default:"[]" }}, 
                    datasets: [{ 
                        label: 'Monthly Net', 
                        data: {{ month_data_json|safe|default:"[]" }}, 
                        borderColor: '#10b981', 
            ...
            new Chart(ctxYear, {
                type: 'line',
                data: { 
                    labels: {{ year_labels_json|safe|default:"[]" }}, 
                    datasets: [{ 
                        label: 'Yearly Aggregate', 
                        data: {{ year_data_json|safe|default:"[]" }}, 
                        borderColor: '#06b6d4', 
            ...
            // Exec Bar Chart
            new Chart(document.getElementById('execRevBarChart').getContext('2d'), {
                type: 'bar',
                data: { 
                    labels: {{ exec_labels_json|safe|default:"[]" }}, 
                    datasets: [{ 
                        data: {{ exec_data_json|safe|default:"[]" }}, 
            ...
            // State Visits Chart
            new Chart(document.getElementById('stateVisitsChart').getContext('2d'), {
                type: 'bar',
                data: { 
                    labels: {{ state_labels_json|safe|default:"[]" }}, 
                    datasets: [{ 
                        data: {{ state_data_json|safe|default:"[]" }}, 
            ...
            // Product Sales Donut
            new Chart(document.getElementById('prodSalesDonut').getContext('2d'), {
                type: 'doughnut',
                data: { 
                    labels: {{ prod_labels_json|safe|default:"[]" }}, 
                    datasets: [{ 
                        data: {{ prod_data_json|safe|default:"[]" }}, 
            ...
            // Problems Donut
            new Chart(document.getElementById('problemsDonut').getContext('2d'), {
                type: 'doughnut',
                data: { 
                    labels: {{ problem_labels_json|safe|default:"[]" }}, 
                    datasets: [{ 
                        data: {{ problem_data_json|safe|default:"[]" }}, 
